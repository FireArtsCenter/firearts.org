...
export default function Header({title = 'Fire Arts Center of Chicago'}: HeaderProps) {
	return (
		<>
			<a
				id='skip'
			...
			<header className='md:col-start-1 md:col-span-5 md:grid md:grid-cols-4 md:items-center mb-4 md:mb-0'>
				...
				<Link className='border-b-0 hover:border-b-0 focus:border-b-0 hidden md:block' href='/'>
